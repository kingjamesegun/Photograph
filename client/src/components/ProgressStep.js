          ...
          <div className="flex items-center">
            ...
            <Link to="/progress">
              <div className="flex items-center text-purple-500 relative">
                {/* icon */}
                <div
                  className="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 bg-purple-500 border-purple-500"
                >
                  <svg
                ...
                {/* text */}
                <div
                  className="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-purple-500"
                >
                  Personal
                </div>
              </div>
            ...
            <div
              className="flex-auto border-t-2 transition duration-500 ease-in-out border-purple-500"
            ></div>
