    ...
    return (
        <div>
            ...
            <div className="flex py-2 mt-4">
                ...
                <button
                className=" mx-3 bg-purple-500 text-white active:bg-purple-600 font-bold uppercase text-sm px-8 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                type="button">
                Next 
                </button>
                </div>
